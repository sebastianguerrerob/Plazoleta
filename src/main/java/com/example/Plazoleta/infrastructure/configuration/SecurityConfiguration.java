    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/Plazoleta/restaurante/*/eficiencia").hasRole("PROPIETARIO")
                        .requestMatchers(HttpMethod.GET, "/Plazoleta/restaurante/*/eficiencia/ranking").hasRole("PROPIETARIO")
